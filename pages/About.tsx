...
import { ShieldCheck, Brain, HeartHandshake, Users, GraduationCap, Baby, BookOpen, Calculator, Gamepad2, Palette, Flower, Library, Pencil, Swords, Music, Languages, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="bg-pastel-green py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 text-center relative z-10 w-full min-w-0">
